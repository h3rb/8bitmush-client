...
var mx=mouse_x; // change to rmx, rmy using surfaces
var my=mouse_y;
//var rmx=(mx-ecks)/w;
//var rmy=(my-why)/h;

var shifted= keyboard_check(vk_shift) or global.key_pressed[265] or global.key_pressed[260] or global.shiftlock;
