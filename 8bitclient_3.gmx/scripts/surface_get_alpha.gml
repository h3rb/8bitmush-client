...
var surface_1=surface_request(global.surface_1);
surface_set_target(surface_1);
draw_clear_alpha(c_white,1);
draw_set_blend_mode_ext(bm_zero,bm_src_alpha);    
draw_surface_part(argument0,argument1,argument2,1,1,0,0);
surface_reset_target();
var result=surface_getpixel(surface_1,0,0);
var r=color_get_red(result);
var g=color_get_green(result);
var b=color_get_blue(result);
var lum=((r+g+b)/3)/255.0;
